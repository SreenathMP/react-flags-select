...
var ReactFlagsSelect1 = function (_Component) {
	_inherits(ReactFlagsSelect1, _Component);

	function ReactFlagsSelect1(props) {
		_classCallCheck(this, ReactFlagsSelect1);
	...
	ReactFlagsSelect1.prototype.toggleOptions = function toggleOptions() {
		!this.state.disabled && this.setState({
			openOptions: !this.state.openOptions
		});
	};

	ReactFlagsSelect1.prototype.toggleOptionsWithKeyboard = function toggleOptionsWithKeyboard(evt) {
		evt.preventDefault();
		if (evt.keyCode === 13) {
	...
	ReactFlagsSelect1.prototype.closeOptions = function closeOptions(event) {
	...
	ReactFlagsSelect1.prototype.onSelect = function onSelect(countryCode) {
		this.setState({
	...
	ReactFlagsSelect1.prototype.onSelectWithKeyboard = function onSelectWithKeyboard(evt, countryCode) {
		evt.preventDefault();
		if (evt.keyCode === 13) {
			//enter key: select
	...
	ReactFlagsSelect1.prototype.updateSelected = function updateSelected(countryCode) {
	...
	ReactFlagsSelect1.prototype.filterSearch = function filterSearch(evt) {
		var _this2 = this;
	...
	ReactFlagsSelect1.prototype.setCountries = function setCountries() {
		var _this3 = this;
	...
	ReactFlagsSelect1.prototype.componentDidMount = function componentDidMount() {
		this.setCountries();
		!this.props.disabled && window.addEventListener("click", this.closeOptions);
	};

	ReactFlagsSelect1.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
		if (prevProps.countries !== this.props.countries || prevProps.blackList !== this.props.blackList) {
			this.setCountries();
		}
	};

	ReactFlagsSelect1.prototype.componentWillUnmount = function componentWillUnmount() {
		!this.props.disabled && window.removeEventListener("click", this.closeOptions);
	};

	ReactFlagsSelect1.prototype.render = function render() {
		var _this4 = this;
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				isSelected && _react2.default.createElement(
					...
					_react2.default.createElement('img', { src: require('../flags/globe.svg'), alt: isSelected }),
...
ReactFlagsSelect1.propTypes = process.env.NODE_ENV !== "production" ? {
...
exports.default = ReactFlagsSelect1;
